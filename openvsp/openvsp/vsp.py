...
def ConvertRtoL(geom_id, surf_indx, r, l):
    return _vsp.ConvertRtoL(geom_id, surf_indx, r, l)

def ConvertLMNtoRST(geom_id, surf_indx, l, m, n, r, s, t):
    return _vsp.ConvertLMNtoRST(geom_id, surf_indx, l, m, n, r, s, t)

def ConvertLtoR(geom_id, surf_indx, l, r):
    return _vsp.ConvertLtoR(geom_id, surf_indx, l, r)

def ConvertUtoEta(geom_id, u, eta):
    return _vsp.ConvertUtoEta(geom_id, u, eta)

def ConvertEtatoU(geom_id, eta, u):
    return _vsp.ConvertEtatoU(geom_id, eta, u)
